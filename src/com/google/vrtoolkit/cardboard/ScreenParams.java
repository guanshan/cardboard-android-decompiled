...
public class ScreenParams {
	...
	public ScreenParams(Display display) {
		...
		this.xMetersPerPixel = (METERS_PER_INCH / metrics.xdpi);
		this.yMetersPerPixel = (METERS_PER_INCH / metrics.ydpi);
	...
	public static ScreenParams fromProto(Display display,
		...
		if (params.hasXPpi()) {
			screenParams.xMetersPerPixel = (METERS_PER_INCH / params.getXPpi());
		}
		if (params.hasYPpi()) {
			screenParams.yMetersPerPixel = (METERS_PER_INCH / params.getYPpi());
		}
